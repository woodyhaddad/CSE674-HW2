...
void WindowsStopwatch::start() { ::Sleep(0); QueryPerformanceCounter((LARGE_INTEGER*)&a); }
void WindowsStopwatch::stop() { QueryPerformanceCounter((LARGE_INTEGER*)&b); }
long WindowsStopwatch::getTime() { __int64 d = (b - a); __int64 ret_milliseconds; ret_milliseconds = (d * 1000UL) / f; return ret_milliseconds; }
#endif